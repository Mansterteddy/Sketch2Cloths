...
segImage_path = dataset_dir + "sketch2img/segCloth/"

label_dirs = os.listdir(label_annotations_path)

all_class = [i for i in range(59)]
reserved_class = [4, 5, 6, 10, 11, 13, 14, 22, 24, 25, 26, 27, 30, 31, 35, 38, 40,
                    42, 46, 48, 49, 50, 51, 53, 54, 55]
removed_class = []
for cloth_glass in all_class:
    if cloth_glass not in reserved_class:
        removed_class.append(cloth_glass)
